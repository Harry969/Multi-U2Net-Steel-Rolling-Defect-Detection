...
if __name__ == "__main__":
    ...
    score = 0
    ####计算class IoU分数####5555555555555555555555_npy/7777777777777777777_npy
    pred_dir = r'D:\RNC14X\multi_U2NET\npy\000000000000000'  # 模型预测结果的路径
    base_dir = r'D:\RNC14X\multi_U2NET\npy\00000000000000'  # 基准模型预测结果的路径
